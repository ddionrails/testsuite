...
shutil.copy2("03-temp/test_gen.csv", "04-data-distribution/output/generations/test_gen.csv")

shutil.copy2("03-temp/test_gen_stats.json", "04-data-distribution/output/statistics/test_gen_stats.json")
